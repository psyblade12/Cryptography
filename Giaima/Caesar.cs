...
namespace Giaima
{
    public partial class Caesar : Form
    {
        ...
        static string[] mang = new string[100];
        static int[] mangchuaketqua = new int[100];
        
        static string chuoinhapvao;
        static string chuoiketqua;
        static int key;
        string chuoitamdemspacebar;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //chuoitamdemspacebar = textBox1.Text;
                ...
                //for (int i = 0; i < chuoitamdemspacebar.Length; i++)
                //{
                //    if (chuoinhapvao.IndexOf(" ") != -1)
                //    {
                //        int tam = chuoitamdemspacebar.IndexOf(" ");
                //        vitrispacebar[i] = tam;
                //        chuoitamdemspacebar = chuoitamdemspacebar.Remove(tam, 1);
                //        chuoitamdemspacebar = chuoitamdemspacebar.Insert(tam, "-");
                //    }
                ...
                {
                    mang[i] = chuoinhapvao.Substring(i, 1);
                }

                for (int i = 0; i < dodaichuoinhapvao; i = i + 1)
                {
                    mangchuaketqua[i] = (DoiChuThanhSo(mang[i]) + key) % 26;
                }

                for (int i = 0; i < dodaichuoinhapvao; i = i + 1)
                {
                    chuoiketqua = chuoiketqua + DoiSoThanhChu(mangchuaketqua[i]);
                }
                for (int i = 0; i < 100; i++)
                {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //chuoiketqua =  chuoiketqua.ToLower();
                textBox2.Text = chuoiketqua;
                //textBox2.Text = Convert.ToString(-27 % 26);
            }
            catch
            {
                MessageBox.Show("Có lỗi xảy ra.");
